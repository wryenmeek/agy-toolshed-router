...
function selectedWiringScope(overrideScope = null) {
  if (overrideScope === 'project' || overrideScope === 'user') return overrideScope;
  if (process.env.MODEL_GATEWAY_SCOPE === 'user' || process.env.MODEL_GATEWAY_SCOPE === 'project') {
    return process.env.MODEL_GATEWAY_SCOPE;
  }
  return WIRING_SCOPE;
}
