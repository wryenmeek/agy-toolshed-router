...
- Surface nonzero, signal-terminated, and partial-output AGY CLI requests as upstream `502` errors instead of successful empty completions, including SSE error signaling for streaming requests.
